  ...
  return (
    <div className="bg-slate-400 py-10 px-5 flex flex-col space-y-5">
      <div className="bg-white p-10 rounded-2xl">
        ...
        <button className="mt-5 bg-blue-500 text-white p-2 text-center rounded-lg w-1/2 mx-auto transition-all block
      ...
      <div className="bg-white p-6 rounded-3xl shadow-xl">
        <div className="flex mb-5 justify-between items-center">
          ...
          <div className="space-x-3">
            <span>⭐️ 4.9</span>
            <span className="shadow-md p-2 rounded-md">❤</span>
          </div>
        </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-5">
              <button className=" rounded-lg bg-blue-200 flex justify-center items-center aspect-square w-8 text-xl text-gray-500 align-middle">
                -
              </button>
              <span>1</span>
              <button className=" rounded-lg bg-blue-200 flex justify-center items-center aspect-square w-8 text-xl text-gray-500 align-middle">
